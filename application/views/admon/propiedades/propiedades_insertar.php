        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
                ...
                <div class="ibox-content">
                    ...
                    <?php echo form_open_multipart('admon/propiedades/insercion', array('id' => 'postFrm', 'class' => 'form-horizontal')); ?>
                        ...
                        <div class="col-sm-10">
                            <select class="form-control m-b" name="estatus_propiedad_id"
                                ...
                                <?php foreach ($estatus_props as $status): ?>
                                    <option value="<?php echo $status->estatus_propiedad_id; ?>" <?php echo set_select('estatus_propiedad_id', $status->estatus_propiedad_id); ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea rows="3" cols="30" placeholder="Descripción de la propiedad en español"
                                      ...
                                      required><?php echo set_value('descripcion_es'); ?></textarea>
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea rows="3" cols="30" placeholder="Descripción de la propiedad en ingles"
                                      ...
                                      minlength="5" data-msg-minlength="Se requieren al menos {0} caracteres"
                                      data-msg-required="Campo requerido"
                                      required><?php echo set_value('descripcion_en'); ?></textarea>
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" placeholder="M2 Utilizables"
                                   value="<?php echo set_value('metros_utiles'); ?>"
                        ...
                        <div class="col-sm-5">
                            <input type="text" placeholder="M2 Construcidos"
                                   value="<?php echo set_value('metros_construidos'); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input type="text" placeholder="# Cuartos"
                                   value="<?php echo set_value('cuartos'); ?>"
                        ...
                        <div class="col-sm-2">
                            <input type="text" placeholder="# Salas"
                                   value="<?php echo set_value('salas'); ?>"
                        ...
                        <div class="col-sm-2">
                            <input type="text" placeholder="# Cocinas"
                                   value="<?php echo set_value('cocinas'); ?>"
                        ...
                        <div class="col-sm-2">
                            <input type="text" placeholder="# Baños"
                                   value="<?php echo set_value('banos'); ?>"
                        ...
                        <div class="col-sm-2">
                            <input type="text" placeholder="# Cajones Estacionamiento"
                                   value="<?php echo set_value('cajones_estacionamiento'); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" placeholder="Precio Avalúo" id="precio_avaluo"
                                   value="<?php echo set_value('precio_avaluo'); ?>"
                        ...
                        <div class="col-sm-5">
                            <input type="text" placeholder="Precio Público" id="precio_publico"
                                   value="<?php echo set_value('precio_publico'); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="text" placeholder="Calle"
                                   value="<?php echo set_value('calle'); ?>"
                        ...
                        <div class="col-sm-1">
                            <input type="text" placeholder="# Exterior"
                                   value="<?php echo set_value('no_exterior'); ?>"
                        ...
                        <div class="col-sm-1">
                            <input type="text" placeholder="# Interior"
                                   value="<?php echo set_value('no_interior'); ?>"
                        ...
                        <div class="col-sm-2">
                            <input type="text" placeholder="CP"
                                   value="<?php echo set_value('codigo_postal'); ?>"
                            ...
                            <select class="form-control m-b" name="pais" id="pais"
                                ...
                                <?php foreach ($paises as $pais): ?>
                                    <option value="<?php echo $pais->nombre; ?>"
                                            data-val="<?php echo $pais->cat_paises_id; ?>" <?php echo ($pais->nombre == 'México') ? 'selected' : '' ?>>
                            ...
                            <div>
                                <label>
                                    <input type="checkbox" name="destacada"
                                           value="1" <?php echo set_checkbox('destacada', '1'); ?>>
                            ...
                            <div>
                                <label>
                                    <input type="checkbox" name="pagina_inicio"
                                           value="1" <?php echo set_checkbox('pagina_inicio', '1'); ?>>
                            ...
                            <div>
                                <label>
                                    <input type="checkbox" name="oferta_especial"
                                           value="1" <?php echo set_checkbox('oferta_especial', '1'); ?>>
                            ...
                            <div>
                                <label>
                                    <input type="checkbox" name="estatus"
                                           value="1" <?php echo set_checkbox('estatus', '1', true); ?>>
...
<script>
    ...
    $(document).ready(function () {
        ...
        obtener_estados_por_pais(143, 'estado'); //Siempre empezamos por mex
