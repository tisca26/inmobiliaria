                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" placeholder="Nombre(s)"
                                   value="<?php echo set_value('nombre', $agente->nombre); ?>" name="nombre"
                                   class="form-control"
                        ...
                        <div class="col-sm-3">
                            <input type="text" placeholder="Apellido Paterno"
                                   value="<?php echo set_value('apellido_paterno', $agente->apellido_paterno); ?>"
                        ...
                        <div class="col-sm-3">
                            <input type="text" placeholder="Apellido Materno"
                                   value="<?php echo set_value('apellido_materno', $agente->apellido_materno); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" placeholder="Teléfono Móvil"
                                   value="<?php echo set_value('tel_movil', $agente->tel_movil); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" placeholder="Teléfono Fijo"
                                   value="<?php echo set_value('tel_fijo', $agente->tel_fijo); ?>"
                        ...
                        <div class="col-sm-2">
                            <input type="text" placeholder="Ext"
                                   value="<?php echo set_value('tel_fijo_ext', $agente->tel_fijo_ext); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="email" placeholder="Email"
                                   value="<?php echo set_value('email', $agente->email); ?>"
                                   name="email"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="url" placeholder="Link de Facebook"
                                   value="<?php echo set_value('facebook_profile', $agente->facebook_profile); ?>"
                                   name="facebook_profile" class="form-control"
                                   minlength="10" data-msg-minlength="Se requieren al menos {0} caracteres">
                        </div>
                        <div class="col-sm-3">
                            <input type="url" placeholder="Link de Twitter"
                                   value="<?php echo set_value('twitter_profile', $agente->twitter_profile); ?>"
                                   name="twitter_profile" class="form-control"
                                   minlength="10" data-msg-minlength="Se requieren al menos {0} caracteres">
                        </div>
                        <div class="col-sm-3">
                            <input type="url" placeholder="Link de LinkedIn"
                                   value="<?php echo set_value('linkedin_profile', $agente->linkedin_profile); ?>"
                            ...
                            <div>
                                <label>
                                    <input type="checkbox" name="estatus"
                                           value="1" <?php echo set_checkbox('estatus', '1', (bool)$agente->estatus); ?>>
